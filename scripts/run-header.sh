...
get_install_packages() {
    ...
    case "$pm" in
        pacman)
            echo "python python-gobject gtk4 libadwaita"
            ;;
        apt)
            echo "python3 python3-gi python3-gi-cairo gir1.2-gtk-4.0 gir1.2-adw-1 libadwaita-1-0"
            ;;
        dnf)
            echo "python3 python3-gobject gtk4 libadwaita"
            ;;
        zypper)
            echo "python3 python3-gobject python3-gobject-Gdk typelib-1_0-Gtk-4_0 typelib-1_0-Adw-1 libadwaita-1-0"
            ;;
        *)
            echo ""
            ;;
